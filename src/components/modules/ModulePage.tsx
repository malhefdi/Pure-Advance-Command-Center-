      ...
      <div className="mx-auto max-w-6xl p-4 md:p-6 desktop:p-7">
        ...
        <section className="rounded-lg border border-border-default bg-white p-6 shadow-1">
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-3">
            {module.bullets.map((bullet) => <div key={bullet} className="rounded-md border border-border-default bg-surface-bg p-4"><p className="text-sm font-semibold text-text-primary">{bullet}</p><p className="mt-2 text-caption text-text-muted">Ready for live source records and module-specific workflows.</p></div>)}
          </div>
        </section>
      </div>
    </AppShell>
